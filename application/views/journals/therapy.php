...
<script type = 'text/javascript' src="<?php echo AD_JS_PATH?>login/login41535.js"></script> 
   ...
   <body>
      <form data-toggle="validator" role="form" action="<?php echo JOURNALS_ADD_THERAPY_PATH ;?>" method="POST">
  ...
  <div class="panel panel-default">
    <div class="panel-heading"><h3>Therapy Details</h3></div>
                     ...
                     <div class="row journal_entry_inputs">
                        <strong>
                           <div class="col-xs-3">Type Of Therapy</div>
                     ...
                     <div class="row journal_entry_inputs">
                        <div class="col-xs-3">
                           <div class="form-group">
                              <input type="text" class="form-control" name="typeoftherapy[]"required>
                           </div>
                        </div>
                        <div class="col-xs-3">
                           <div class="form-group">
