...
$('#btn').click(){
 ...
 $( "#inputdateofbirth" ).datepicker({
   ...
   <body>
      <form data-toggle="validator" role="form" action="<?php echo ADD_USER;?>" method="POST">
         <div class="right_col" role="main">
            <div class="row">
               <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="dashboard_graph">
                     <h1 align="left" class="col-md-6"><a href="<?php echo LOGIN;?>">login</a></h1>
      ...
      <div class="clearfix"></div>
      <div class="form-group">
      <label for="inputDateofbirth" class="control-label " >D.O.B:</label>
      <input type="text" class="datepicker" name="inputdateofbirth" id="inputdateofbirth" required>
      </div>
      <div class="clearfix"></div>
      <div class="form-group">
      <label for="inputContact" class="control-label " >Contact:</label>
      <input type="text" name="quantity" id="quantity" required/>&nbsp;<span id="errmsg"></span>
      </div>
      <div class="clearfix"></div>
      <div class="form-group">
