...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Golf Info Network - Password change request</title>
        <style type="text/css">
            /* RESET STYLES */
            html { background-color:#DAA520; margin:0; padding:0; }
            ...
            body, #bodyTable{background-color:#DAA520;}
                                                            ...
                                                            <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td align="center" valign="top" class="textContent">
                                                                        <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%; color:white;">Sanskrit For Kids</h2>                                                                        
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
                                                                        ...
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td valign="top" class="textContent">
                                                                                    <h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Dear&nbsp;<?php echo $userName ?> ,</h3><br/>
                                                                                    <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">Welcome to <?php echo APP_TITLE; ?>, the smarter solution to learn Sanskrit any time, anywhere. <br/><br/>Kindly to inform you that this email is sent to you as per your request.<br/><br/>Your account with <?php echo APP_TITLE ?> is created successfully <br/><br/>User Name : <strong><?php echo $email ?></strong><br/>Password : <strong><?php echo $password; ?></strong><br/><br/><br/>Regards,<br/>Team<br/> <?php echo APP_TITLE ?>.</div>
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="top">
                                                                        ...
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td valign="top" class="textContent">
                                                                                    <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">This message was sent from a notification-only email address that does not accept incoming email. Please do not reply to this message.</div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <!-- // CONTENT TABLE -->
