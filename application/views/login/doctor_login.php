               ...
               <div class="dashboard_graph">
                  ...
                  <div class="container">
                     <ul class="nav nav-pills">
                        <li><a href="<?php echo LOGIN;?>">USER</a></li>
    <li class="active"><a href="">DOCTOR</a></li>
                     </ul>
                     <hr>
                  </div>
                  <form data-toggle="validator" role="form" action="<?php echo DOCTOR_VALIDATE;?>" method="POST">
                     <h1 align="left" class="col-md-3">login</h1>
                     <h1 align="center" class="col-md-3"><a href="<?php echo DOCTOR_REGISTER;?>">register</a></h1>
